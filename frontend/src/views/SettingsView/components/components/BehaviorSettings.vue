...
if (!isWeb && envStore.env.os === OS.Windows) {
...
<template>
  ...
  <Card>
    ...
    <div v-if="!isWeb" class="px-8 py-12 flex items-center justify-between">
      <div class="text-16 font-bold">
    ...
    <div v-if="!isWeb" v-platform="[OS.Linux]" class="px-8 py-12 flex items-center justify-between">
      <div class="text-16 font-bold">
